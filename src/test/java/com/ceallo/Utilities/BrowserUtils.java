...
public class BrowserUtils {
    /*
   this method will accept seconds and execute Thread.sleep for given duration
    */
...
//        Driver.getDriver().manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS);
     ...
     * @param expectedTitle
     */
    public static void verifyUrlContain(String expectedTitle) {
    ...
    public static List<String> dropdownOptionAsString(WebElement dropdownElement) {
        ...
        for (WebElement each : actualOptions) {
            actualOptionText.add(each.getText());

        }


        return actualOptionText;
    ...
    public static void clickRadioButton(List<WebElement> radioButton, String attributeValue) {
        ...
        for (WebElement each : radioButton) {
            ...
            if (each.getAttribute(attributeValue).equalsIgnoreCase(attributeValue)) {
                each.click();
            }
